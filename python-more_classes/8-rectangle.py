#!/usr/bin/python3
"""
8-rectangle.py: Defines a Rectangle class with instance tracking,
custom print symbol, comparison, width, height, area, perimeter,
...
class Rectangle:
    ...
    comparison, width, height, area, perimeter, string representation,
