#!/usr/bin/python3
"""
6-rectangle.py: Defines a Rectangle class with
instance tracking, width, height, area, perimeter,
...
class Rectangle:
    """
    Defines a rectangle with instance tracking, width, height, area, perimeter,
    string representation, and deletion message.
